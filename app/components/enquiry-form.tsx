...
export default function EnquiryForm() {
  ...
  return <>
    ...
    <fieldset hidden={step !== 0} disabled={state === 'sending'}><legend ref={node => { legends.current[0] = node; }} tabIndex={-1}>Your project</legend>
      ...
      <div className="challenge-panel" hidden={!config?.turnstileSiteKey}><p>A quick check confirms you are a person. It also unlocks file attachments.</p><div ref={challenge}/></div>
