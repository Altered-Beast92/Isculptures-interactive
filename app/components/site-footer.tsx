...
export default function SiteFooter() {
  ...
  return <footer id="about" className={'site-footer story-footer' + (onEnquiry ? ' enquiry-page-footer' : '')}>
    ...
    {!onEnquiry && <><span>YOUR NEXT CHAPTER</span><h2>Let’s make<br/>something.</h2>
    ...
    <div><b>For your next project</b><a href="/services">All 3D printing services</a><a href="/pages/events-custom-gifts">Corporate gifts &amp; event favours</a><a href="/pages/wholesale">Wholesale &amp; bulk orders</a><a href="/pages/ongoing-supply">Repeat orders &amp; supply</a><a href="/pages/bonbonniere-custom">Bonbonniere &amp; keepsakes</a><a href="/pages/about">About the studio</a></div>
