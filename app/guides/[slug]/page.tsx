...
export default async function GuidePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main id="main-content" className="document-page guide-page"><article>
    <a className="guide-back" href="/guides">← All guides</a><p className="section-tag">{guide.category}</p><h1>{guide.title}</h1><p className="document-lede">{guide.summary}</p><p className="guide-byline">From the iSculptures studio</p>
