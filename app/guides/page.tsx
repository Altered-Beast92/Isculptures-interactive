...
export default function GuidesPage() {
  return <main id="main-content" className="document-page guides-index"><Breadcrumbs items={[{ name: 'Guides', path: '/guides' }]}/><header className="page-intro"><p className="section-tag">GUIDES</p><h1>Guides to planning <br/><i>your order.</i></h1><p className="document-lede">Help with quotes, pricing, event favours and repeat orders, written by our studio.</p></header><h2 className="visually-hidden">All guides</h2><GuideGrid items={guides}/><div className="guide-enquiry"><h2>Ready to get a quote?</h2><p>Send us your idea, how many you need and when. We’ll take it from there.</p><a href="/enquiry" className="primary">Get a quote ↗</a></div></main>;
}
