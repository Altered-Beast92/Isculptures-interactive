...
export const metadata = pageMetadata('Guides to bulk 3D printing & custom orders', 'Practical guides to planning bulk 3D printing, event favours, custom gift packaging and repeat production orders with iSculptures.', '/guides');
