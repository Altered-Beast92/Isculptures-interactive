...
export const metadata = pageMetadata('Guides to ordering bulk 3D printing & custom keepsakes', 'How to plan a bulk 3D printing order: what to include in a quote, what affects cost, and ordering favours for weddings, christenings and baby showers.', '/guides');
