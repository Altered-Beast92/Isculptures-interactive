...
export const metadata = pageMetadata('Our work: custom favours, keepsakes & gifts', 'Photos of event favours, personalised keepsakes, religious icons and gift boxes made by Impeccable Sculptures. Bulk orders start at 10 units.', '/work');
