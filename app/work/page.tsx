...
export const metadata = pageMetadata('Selected work — custom favours & gifts', 'Explore Impeccable Sculptures event favours, personalised keepsakes, commemorative icons and custom gift boxes. Enquire about bulk orders from 10 units.', '/work');
