  ...
  return <main id="main-content" className="document-page policy-page"><article>
    ...
    <div className="policy-layout">
      <div className="policy-body">
        ...
        <section className="service-cta is-compact"><div><p className="section-tag">QUESTIONS</p><h2>Talk to the studio.</h2><p>Include your enquiry or order reference if you have one.</p></div><div className="service-cta-actions"><a className="primary" href={'mailto:' + CONTACT.email}>{CONTACT.email}</a><a href={'tel:' + CONTACT.tel}>{CONTACT.phone}</a></div></section>
      </div>
