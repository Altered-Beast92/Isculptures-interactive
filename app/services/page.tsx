...
export const metadata = pageMetadata('3D printing services in Sydney', 'Bulk orders, event favours, bonbonniere, religious keepsakes, parts, prototypes and repeat supply from our Sydney 3D printing studio.', '/services');
